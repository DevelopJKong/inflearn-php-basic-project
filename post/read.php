    ...
    <article class="uk-margin uk-article">
        ...
        <div class="uk-text-meta">
            ...
            <?php if (isset($isOwner)) : ?>
                <span class="owner">
                    <a href="/php_inflearn_board/post/delete_process.php?id=<?=$id?>&token=<?=$_SESSION['CSRF_TOKEN']?>" class="uk-link-text" id="delete">Delete</a>
                    <a href="/php_inflearn_board/post/update.php?id=<?=$id?>" class="uk-link-text" id="delete">Update</a>
                </span>
            <?php endif; ?>
        </div>
